...
2. Download zip/clone dependency [AsyncTCP](https://github.com/me-no-dev/AsyncTCP) to file.
3. Download zip/clone dependency [ESPAsyncWebServer](https://github.com/me-no-dev/ESPAsyncWebServer) to file.
...
3. In the terminal type the following to install [esptool](https://pypi.org/project/esptool/) via Python package manager:
   ```
   pip install esptool
   ```
4. Install [setuptools](https://pypi.org/project/setuptools/) dependencies:
   ```
